...
迁移 ID: 394f08c4f06b
父迁移:
创建时间: 2026-08-08 10:20:41.630131
...
revision: str = "394f08c4f06b"
down_revision: str | Sequence[str] | None = None
branch_labels: str | Sequence[str] | None = ("bison",)
...
def upgrade(name: str = "") -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["nonebot_bison_target.id"],
            name=op.f(
                "fk_nonebot_bison_scheduletimeweight_target_id_nonebot_bison_target"
            ),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["nonebot_bison_user.id"],
            name=op.f("fk_nonebot_bison_subscribe_user_id_nonebot_bison_user"),
        ),
